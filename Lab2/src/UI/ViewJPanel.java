...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 530, 208));

        lblTitle.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
        lblTitle.setText("View Vital Sign History");
        add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, -1, -1));

        lblDate.setText("Date");
        add(lblDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 370, -1, -1));

        lblTemperature.setText("Temperature");
        add(lblTemperature, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 400, -1, -1));

        lblBp.setText("Blood Pressure");
        add(lblBp, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 430, -1, -1));

        lblPulse.setText("Pulse");
        add(lblPulse, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 460, -1, -1));

        lblConscious.setText("Conscious Status");
        add(lblConscious, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 500, -1, -1));

        fieldDate.setColumns(18);
        add(fieldDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 370, -1, -1));

        fieldTemperature.setColumns(18);
        add(fieldTemperature, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 400, -1, -1));

        fieldBp.setColumns(18);
        add(fieldBp, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 430, -1, -1));

        fieldPulse.setColumns(18);
        add(fieldPulse, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 460, -1, -1));
        add(lblStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 490, 120, 30));
        ...
        add(btnView, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 300, -1, -1));
        ...
        add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 300, -1, -1));
