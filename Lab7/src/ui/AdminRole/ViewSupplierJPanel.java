...
public class ViewSupplierJPanel extends javax.swing.JPanel {
   ...
   private void btnManageProductsActionPerformed(ActionEvent evt) {
    ManageProductCatalogJPanel panel = new ManageProductCatalogJPanel(userProcessContainer, supplier.getProductCatalog());
